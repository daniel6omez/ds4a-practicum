...
def update_month_day_heat(dff = df):
    ...
    fig.update_layout(yaxis_nticks=24,margin=dict(l=10, r=10, t=10, b=10))
...
def update_day_hour_heat(dff = df):
    ...
    fig.update_xaxes(side="top")
    fig.update_layout(xaxis_nticks=24,margin=dict(l=10, r=10, t=10, b=10))
